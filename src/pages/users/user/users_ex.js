      ...
      render: (text, record, index) => {
        const resultsOnline = () => {
          if (record.status_connection === "Active") {
            return (
              <Badge text="Active" color={'#5bc725'} />
            )
          } else {
            return (
    ...
    return (
      <div>
        <Button className="styledPopDelete" btnSize={"wd_df"} type="link" ghost >
          <p className="action-delete-p">{labelShow.edit ? labelShow.edit : 'Edit'}</p>
        </Button>
        <br />
        <Button className="styledPopDelete" btnSize={"wd_df"} type="link" ghost onClick={() => confirm(users)}>
          <p className="action-delete-p">{labelShow.delete ? labelShow.delete : 'Delete'}</p> 
        </Button>
      </div> 
      // <Menu className="action-delete-menu">
      //     <Menu.Item className="action-delete">
      //       <span className="action-delete-span">{labelShow.edit ? labelShow.edit : 'Edit'}</span>
      //       {/* <a className="action-delete-a">{labelShow.edit ? labelShow.edit : 'Edit'}</a> */}
      //     </Menu.Item>
      //     <Menu.Item className="action-delete" onClick={() => confirm(users)}>
      //       <span className="action-delete-span">{labelShow.delete ? labelShow.delete : 'Delete'}</span>
      //       {/* <a className="action-delete-a">{labelShow.delete ? labelShow.delete : 'Delete'}</a> */}
      //     </Menu.Item>
      // </Menu>
    );
  };
